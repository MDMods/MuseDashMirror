...
namespace MuseDashMirror.UICreate
{
    public static class ToggleCreate
    {
        ...
        {
            var toggle = UnityEngine.Object.Instantiate(GameObject.Find("Forward").transform.Find("PnlVolume").Find("LogoSetting").Find("Toggles").Find("TglOn").gameObject, GameObject.Find(parentName).transform);
            toggle.name = name;
        ...
        {
            var toggle = UnityEngine.Object.Instantiate(GameObject.Find("Forward").transform.Find("PnlVolume").Find("LogoSetting").Find("Toggles").Find("TglOn").gameObject, parent.transform);
            toggle.name = name;
        ...
        {
            var toggle = UnityEngine.Object.Instantiate(GameObject.Find("Forward").transform.Find("PnlVolume").Find("LogoSetting").Find("Toggles").Find("TglOn").gameObject, parent);
            toggle.name = name;
