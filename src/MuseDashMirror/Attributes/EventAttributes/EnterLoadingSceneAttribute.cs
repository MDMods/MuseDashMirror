...
public sealed class EnterLoadingSceneAttribute : Attribute, IEventAttribute
{
    /// <summary>
    ///     Register the method to <see cref="OnEnterLoadingScene" />
    /// </summary>
    /// <param name="method"></param>
    public void Register(MethodInfo method)
    {
        OnEnterLoadingScene += (EventHandler<SceneEventArgs>)Delegate.CreateDelegate(typeof(EventHandler<SceneEventArgs>), method);
    }
}