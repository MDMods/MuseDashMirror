...
public sealed class ExitWelcomeSceneAnalyzer : DiagnosticAnalyzer
{
    private const string DiagnosticId = "MDM0110";
    private const string Category = "Usage";
    private static readonly LocalizableString Title = GetLocalizableString(nameof(MDM0110Title));
    private static readonly LocalizableString MessageFormat = GetLocalizableString(nameof(MDM0110MessageFormat));
    private static readonly LocalizableString Description = GetLocalizableString(nameof(MDM0110Description));
    ...
    private static void AnalyzeNode(SyntaxNodeAnalysisContext context)
    {
        ...
        var hasAttribute = symbol.GetAttributes().Any(x => x.AttributeClass!.ToDisplayString() == ExitWelcomeSceneAttributeName);
