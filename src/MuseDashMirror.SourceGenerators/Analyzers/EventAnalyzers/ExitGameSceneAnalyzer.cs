...
public sealed class ExitGameSceneAnalyzer : DiagnosticAnalyzer
{
    private const string DiagnosticId = "MDM0106";
    private const string Category = "Usage";
    private static readonly LocalizableString Title = GetLocalizableString(nameof(MDM0106Title));
    private static readonly LocalizableString MessageFormat = GetLocalizableString(nameof(MDM0106MessageFormat));
    private static readonly LocalizableString Description = GetLocalizableString(nameof(MDM0106Description));
    ...
    private static void AnalyzeNode(SyntaxNodeAnalysisContext context)
    {
        ...
        var hasAttribute = symbol.GetAttributes().Any(x => x.AttributeClass!.ToDisplayString() == ExitGameSceneAttributeName);
