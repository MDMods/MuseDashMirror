...
public sealed class EnterWelcomeSceneAnalyzer : DiagnosticAnalyzer
{
    private const string DiagnosticId = "MDM0109";
    private const string Category = "Usage";
    private static readonly LocalizableString Title = GetLocalizableString(nameof(MDM0109Title));
    private static readonly LocalizableString MessageFormat = GetLocalizableString(nameof(MDM0109MessageFormat));
    private static readonly LocalizableString Description = GetLocalizableString(nameof(MDM0109Description));
    ...
    private static void AnalyzeNode(SyntaxNodeAnalysisContext context)
    {
        ...
        var hasAttribute = symbol.GetAttributes().Any(x => x.AttributeClass!.ToDisplayString() == EnterWelcomeSceneAttributeName);
