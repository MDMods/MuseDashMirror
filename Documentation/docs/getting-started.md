...
The recommended setup is [MuseDash.Mod.Template](https://github.com/MDMods/MuseDash.Mod.Template). Select `MuseDashMirror` in its `UsefulLibs` option and let the template configure the game references and build layout.
